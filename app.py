...
# ====================================================
# 1. NEW ROUTE: DIRECT WEB PLAYER SCREEN (No VLC Buttons)
# ====================================================
async def watch_handler(request):
    try:
        ...
        # Ye seedha tumhare backend se player screen render karega
        html_page = f"""
        <!DOCTYPE html>
        <html lang="en">
        <head>
...
# ====================================================
# 2. RAW STREAM HANDLER (Original video provider)
# ====================================================
