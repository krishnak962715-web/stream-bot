...
# Naya Event Loop banayenge taaki bot aur web server ek hi track par chalein
...
# in_memory=True daala hai taaki server storage ka error na aaye
...
async def media_recv(c, m):
    try:
        ...
        await m.reply_text(f"⚠️ **Error:** Bot abhi channel mein theek se add nahi hai!\n\n**Kripya bot ko apne 'ALL NETFLIX' channel mein Admin banayein.**\n(Error details: {e})")
...
if __name__ == "__main__":
    # Nayi loop setting taaki bot hamesha zinda rahe
